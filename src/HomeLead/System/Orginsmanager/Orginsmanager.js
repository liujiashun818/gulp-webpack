...
var Orginsmanager = React.createClass({
	componentDidMount:function(){ 
		   $('.onload').click(function(){
			...
			/*-------------新建组织机构------------*/
			$('.newOrginclick').click(function(){
			$('.newOrgin').css({display:'block'});
		});
		$('.newtopX,.newCox').click(function(){
				$('.newOrgin').css({'display':'none'});
		}); 
			...
			$.ajax({
				...
				success: function(data) {
					...
					for (var i = 0; i < $num; i++) {
						if (data[i]) {
						$('.orginsTbody').append("<tr><td>"+data[i].qunZhu+"</td><td class='sectionrightright'><span class='setRRspan'><img  class='setRRspanBj setRRspanImg' src='./img/images/系统-1用户管理_06.png'/></span><span class='setRRspan'><img  class='setRRspanBj setRRspanImg' src='./img/images/系统-1用户管理_08.png'/></span><span class='setRRspan'><img  class='setRRspanBj setRRspanImg'  src='./img/images/系统-1用户管理_03.png'/></span></td></tr>")
						}
					}
    						...
    						<div className='usermanagerNav'>
		    							  <div className='usermanagerNavLeft'>
				    						...
				    						<div className='usermanagerNavRight'>
					    								   <p className='usermanagerNavRightP'> <input className='newOrginclick' id="" type="button" value="新建组织机构" /></p>
